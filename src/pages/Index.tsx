...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-brand-purple to-brand-pink text-white py-20 px-6">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6">
            Strengthen <span className="text-brand-white">Local Economies</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button 
              className="bg-white hover:bg-white/90 text-brand-purple font-bold text-lg px-8 py-6"
              onClick={() => navigate("/register")}
            >
              Join Your Community
            </Button>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-brand-purple">
            Community Economic Development
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              <div className="bg-brand-purple/10 rounded-full p-4 inline-block mb-6">
                <RefreshCw className="h-8 w-8 text-brand-purple" />
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 bg-brand-purple text-white">
        <div className="container mx-auto text-center">
